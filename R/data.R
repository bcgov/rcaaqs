...
#'   \item{region_type}{The type of region (Regional District, Regional
#'   Municipality, or Unincorporated Area)} }
#' @source
#'   \url{http://catalogue.data.gov.bc.ca/dataset/ceei-primary-indicators-total-2007-regional-districts}
#'   
"rd_map"
