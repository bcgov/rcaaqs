...
There are accessor/extractor functions to get the different components. We can 
get the caaqs results using the `extract_caaqs()` function:
...
```{r, fig.width = 8, fig.asp = 1.5, eval = require("maptools")}
library(sp)
library(gridExtra)
