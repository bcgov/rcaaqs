...
The `clean_neg()` and `date_fill()` are useful helper functions for ensuring all the values are either 0 or positive and that you have a complete dataframe with no missing hourly readings:
```{r}
